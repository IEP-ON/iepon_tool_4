      ...
      <div className="flex-1 flex flex-col justify-between">
        <div className="space-y-8 text-[10pt]">
          ...
          <section className="print:break-inside-avoid">
            <h2 className="text-[12pt] font-bold mb-4 flex items-center text-gray-900 border-b-2 border-gray-800 pb-2 outline-none" contentEditable suppressContentEditableWarning>
              1. 기본 정보
            </h2>
            <div className="grid grid-cols-2 gap-x-6 gap-y-6">
              ...
              <div className="flex items-center gap-3">
                <span className="text-gray-700 font-medium min-w-[90px] outline-none" contentEditable suppressContentEditableWarning>생년월일:</span>
                <div className="flex-1 border-b border-gray-400 h-8"></div>
              </div>
              <div className="flex items-center gap-3">
          ...
          <section className="print:break-inside-avoid">
            ...
            <div className="space-y-6">
              <div>
                <p className="text-gray-700 font-medium mb-2 outline-none" contentEditable suppressContentEditableWarning>복용 약물:</p>
                <div className="border border-gray-300 rounded-lg p-3 min-h-[120px]"></div>
              </div>
              <div>
                <p className="text-gray-700 font-medium mb-2 outline-none" contentEditable suppressContentEditableWarning>알레르기:</p>
                <div className="border border-gray-300 rounded-lg p-3 min-h-[100px]"></div>
              </div>
              <div>
                <p className="text-gray-700 font-medium mb-2 outline-none" contentEditable suppressContentEditableWarning>특이사항 (기타 건강 관련):</p>
      ...
      <div className="flex-1 flex flex-col justify-between">
        <div className="space-y-8 text-[10pt]">
          ...
          <section className="print:break-inside-avoid">
            ...
            <div className="space-y-6">
              <div>
                <p className="text-gray-700 font-medium mb-2 outline-none" contentEditable suppressContentEditableWarning>학생의 강점 (좋아하고 잘하는 것):</p>
                <div className="border border-gray-300 rounded-lg p-3 min-h-[140px]"></div>
              </div>
              <div>
                <p className="text-gray-700 font-medium mb-2 outline-none" contentEditable suppressContentEditableWarning>개선이 필요한 영역 (도움이 필요한 부분):</p>
                <div className="border border-gray-300 rounded-lg p-3 min-h-[140px]"></div>
              </div>
              <div>
                <p className="text-gray-700 font-medium mb-2 outline-none" contentEditable suppressContentEditableWarning>협의회에서 논의하고 싶은 사항:</p>
                <div className="border border-gray-300 rounded-lg p-3 min-h-[160px]"></div>
              </div>
              <div>
                <p className="text-gray-700 font-medium mb-2 outline-none" contentEditable suppressContentEditableWarning>학교에 바라는 지원 (보조공학기기, 행동지원 등):</p>
                <div className="border border-gray-300 rounded-lg p-3 min-h-[140px]"></div>
              </div>
            </div>
          </section>
            ...
            <div className="space-y-4 ml-2">
              <div className="flex items-center gap-3">
                <label className="flex items-center gap-3 cursor-pointer">
                  ...
                  <span className="text-[11pt] text-gray-900 font-medium outline-none" contentEditable suppressContentEditableWarning>① 학교 방문 (대면)</span>
                </label>
              </div>
              <div className="flex items-center gap-3">
                <label className="flex items-center gap-3 cursor-pointer">
                  <span className="w-6 h-6 border-2 border-gray-400 rounded flex-shrink-0"></span>
                  <span className="text-[11pt] text-gray-900 font-medium outline-none" contentEditable suppressContentEditableWarning>② 전화 상담 (유선)</span>
                </label>
              </div>
              <div className="flex items-center gap-3">
                <label className="flex items-center gap-3 cursor-pointer">
                  <span className="w-6 h-6 border-2 border-gray-400 rounded flex-shrink-0"></span>
                  <span className="text-[11pt] text-gray-900 font-medium outline-none" contentEditable suppressContentEditableWarning>③ 서면 참여 (본 의견서 제출로 갈음)</span>
                </label>
              </div>
              <div className="mt-6 ml-1 p-4 bg-gray-50 border border-gray-200 rounded-lg">
                <p className="text-gray-800 font-medium mb-2 outline-none" contentEditable suppressContentEditableWarning>※ 방문 또는 전화 상담 희망 일시 (①, ② 선택 시)</p>
                <div className="flex items-center gap-2">
                  <span className="text-gray-600 outline-none" contentEditable suppressContentEditableWarning>일시:</span>
        ...
        <div className="mt-auto pt-4 border-t border-gray-300 text-[8.5pt] text-gray-600 flex justify-between items-center">
          <p className="outline-none" contentEditable suppressContentEditableWarning>본 의견서는 「장애인 등에 대한 특수교육법」 제22조에 근거하여 작성되었습니다.</p>
          <p className="font-medium outline-none" contentEditable suppressContentEditableWarning>문의: {teacher.teacherName} (☎ {teacher.teacherPhone})</p>
        </div>
      </div>
    </div>
    </>
