  ...
  return (
    <div className={`mx-auto w-[210mm] h-[297mm] p-10 bg-white print:p-[10mm] print:m-0 print:w-full print:h-full print:shadow-none text-[9pt] leading-snug flex flex-col justify-between overflow-hidden relative ${isEmptyForm ? "print-empty-form" : ""}`}>
      ...
      <div className="space-y-2 flex-1">
        {/* 1. 필수 동의 */}
        <section>
          <h2 className="text-[9pt] font-bold bg-gray-100 p-1 border border-black">1. 필수 동의 사항 (교육 및 지원을 위해 반드시 필요)</h2>
          <table className="w-full border-collapse border border-black mt-[-1px] text-[8pt]">
            <colgroup><col className="w-[75%]" /><col className="w-[25%]" /></colgroup>
            <tbody>
              <tr>
                <td className="border border-black px-1.5 py-1">
                  <p className="font-bold">1) 기본 개인정보 수집·이용 (IEP 수립, 성적·출결 관리 등)</p>
                  <p className="text-gray-500 text-[7pt] mt-0.5">성명, 생년월일, 연락처, 가정환경, 특수교육 선정 현황 등</p>
                </td>
              ...
              <tr>
                <td className="border border-black px-1.5 py-1">
                  ...
                  <p className="text-gray-500 text-[7pt] mt-0.5">장애유형/정도, 복약정보, 알레르기, 발작이력, 감각특성 등 (개인정보보호법 제23조)</p>
                </td>
                <td className="border border-black px-1.5 py-1 text-center align-middle whitespace-nowrap">
              ...
              <tr>
                <td className="border border-black px-1.5 py-1">
                  ...
                  <p className="text-gray-500 text-[7pt] mt-0.5">관련 서비스 신청, 응급상황 대처, 진로·직업 연계 목적</p>
                </td>
                <td className="border border-black px-1.5 py-1 text-center align-middle whitespace-nowrap">
              ...
              <tr>
                <td className="border border-black px-1.5 py-1">
                  ...
                  <p className="text-gray-500 text-[7pt] mt-0.5">학교생활 적응 지원, 통합교육 협력, 급식 지도, 응급처치 대비</p>
                </td>
                <td className="border border-black px-1.5 py-1 text-center align-middle whitespace-nowrap">
        ...
        {/* 2. 생명·안전 */}
        <section>
          <h2 className="text-[9pt] font-bold bg-gray-100 p-1 border border-black">2. 생명 및 안전 보호 (응급처치 동의 — 필수)</h2>
          <table className="w-full border-collapse border border-black mt-[-1px] text-[8pt]">
            <colgroup><col className="w-[75%]" /><col className="w-[25%]" /></colgroup>
            <tbody>
              <tr>
              ...
              <tr>
                <td className="border border-black px-1.5 py-1">
                  ...
                  <p className="text-gray-500 text-[7pt] mt-0.5">보호자 연락 지연 시 학교 판단하에 최우선으로 응급조치를 실시함에 동의</p>
                </td>
                <td className="border border-black px-1.5 py-1 text-center align-middle whitespace-nowrap">
          ...
          <table className="w-full border-collapse border border-black mt-[-1px] text-[8pt]">
            <tbody>
              <tr>
                <th className="border border-black bg-gray-50 px-1.5 py-1 text-left font-bold" colSpan={4}>
              ...
              {isEmptyForm ? (
                <>
                  {[1, 2].map((n) => (
                    <tr key={n}>
                      <td className="border border-black px-1.5 py-1 w-[8%] text-center text-gray-400">{n}순위</td>
                      <td className="border border-black px-1.5 py-1 w-[30%]">성명: ___________</td>
                      <td className="border border-black px-1.5 py-1 w-[20%]">관계: _______</td>
                      <td className="border border-black px-1.5 py-1">연락처: ___________________</td>
                    </tr>
                  ))}
                </>
                ...
                consent.emergencyContacts.map((c, i) => (
                  <tr key={i}>
                    <td className="border border-black px-1.5 py-1 w-[8%] text-center text-gray-500">{i + 1}순위</td>
                    <td className="border border-black px-1.5 py-1 w-[30%]">성명: {c.name}</td>
                    <td className="border border-black px-1.5 py-1 w-[20%]">관계: {c.relation}</td>
                    <td className="border border-black px-1.5 py-1">연락처: {c.phone}</td>
                  </tr>
                ))
              ) : (
                <tr>
                  <td className="border border-black px-1.5 py-1 text-gray-400 text-center" colSpan={4}>등록된 응급 연락망 없음</td>
                </tr>
              )}
            </tbody>
          </table>
        ...
        {/* 3. 교육활동 참여 및 초상권 */}
        <section>
          <h2 className="text-[9pt] font-bold bg-gray-100 p-1 border border-black">3. 교육활동 참여 및 초상권 (선택/권장)</h2>
          <table className="w-full border-collapse border border-black mt-[-1px] text-[8pt]">
            <colgroup><col className="w-[75%]" /><col className="w-[25%]" /></colgroup>
            <tbody>
              <tr>
              ...
              <tr>
                <td className="border border-black px-1.5 py-1">
                  ...
                  <p className="text-gray-500 text-[7pt] mt-0.5">미동의 시 모자이크 처리 또는 뒷모습 위주로 활용됩니다.</p>
                </td>
                <td className="border border-black px-1.5 py-1 text-center align-middle whitespace-nowrap">
              ...
              <tr>
                <td className="border border-black px-1.5 py-1">
                  ...
                  <p className="text-gray-500 text-[7pt] mt-0.5">학부모 공개수업, 동료 장학, 장학공개수업, 연구대회 출품 포함 (미동의 시 불이익 없음)</p>
                </td>
                <td className="border border-black px-1.5 py-1 text-center align-middle whitespace-nowrap">
      ...
      <section className="border-2 border-black p-2 mt-3 shrink-0">
        <p className="text-[8pt] text-center font-bold mb-2">
        ...
        <div className="flex justify-between items-end h-10">
          <div className="text-[7pt] text-gray-500">
            {!isEmptyForm && consent.submissionHash && (
              <>
                <p>제출일시: {new Date(consent.submissionTimestamp || "").toLocaleString("ko-KR")}</p>
                <p className="font-mono mt-0.5 text-[6pt]">인증해시: {consent.submissionHash.substring(0, 32)}...</p>
              </>
            )}
          </div>
          <div className="flex justify-end gap-4 text-[9pt] items-end">
            ...
            <div className="flex items-end gap-1">
              ...
              <span className={isEmptyForm ? "inline-block w-20 border-b border-black mb-1" : "mb-1 font-bold"}>
                {!isEmptyForm ? consent.consentGuardianName : ""}
              </span>
              <span className="mb-1">(서명)</span>
              {!isEmptyForm && consent.consentSignatureBase64 ? (
                <div className="w-20 h-8 border-b border-black relative inline-block">
                  <img src={consent.consentSignatureBase64} alt="보호자 서명" className="absolute bottom-0 w-full max-h-[150%] object-contain" />
                </div>
              ) : (
                <span className="inline-block w-20 h-5 border-b border-black"></span>
              )}
            </div>
          </div>
        </div>
      ...
      <div className="mt-2 text-center text-gray-500 text-[7.5pt] shrink-0 flex justify-between items-center">
        <p>※ 수집된 정보는 특수교육 지원 목적으로만 사용되며, 목적 달성 시 안전하게 파기됩니다.</p>
        {!isEmptyForm && consent.submissionHash && (
          <span className="bg-gray-100 px-2 py-0.5 rounded border border-gray-200 text-[6.5pt] text-gray-400">
            전자문서 위변조 방지 인증 완료
          </span>
        )}
      </div>
