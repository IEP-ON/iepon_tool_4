...
보호자님의 귀한 의견이 우리 아이를 위한 교육 계획의 소중한 밑거름이 될 수 있도록 따뜻한 관심과 참여를 부탁드립니다.`;
  ...
  return (
    <div className="mx-auto w-[210mm] h-[297mm] p-[12mm] bg-white print:p-[10mm] print:m-0 print:w-full print:h-[281mm] print:shadow-none text-[10pt] leading-tight flex flex-col relative print:break-after-page overflow-hidden">
